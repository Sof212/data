...
Durée du script : **17:02**, soit une minute de marge. Le repère indiqué est l'heure à laquelle vous devez *quitter* la diapositive.
...
| 4 | Le terrain : RHG et People AI | 0:40 | 1:43 |
| 5 | Du terrain au sujet de mémoire | 0:45 | 2:28 |
| 6 | Problématique | 0:45 | 3:13 |
| 7 | Intercalaire · Partie 2 | 0:08 | 3:21 |
| 8 | D'où vient le biais, et où on le mesure | 1:25 | 4:46 |
| 9 | Le protocole en un coup d'œil | 2:00 | 6:46 |
| 10 | Que mesure exactement chaque score ? | 1:40 | 8:26 |
| 11 | Intercalaire · Partie 3 | 0:08 | 8:34 |
| 12 | Associations dans les embeddings | 1:15 | 9:49 |
| 13 | Probabilités : le LPBS par domaine | 1:10 | 10:59 |
| 14 | Préférence probabiliste : PLL, AUL et AULA | 1:00 | 11:59 |
| 15 | Ce que produisent les modèles génératifs | 1:15 | 13:14 |
| 16 | Divergence sémantique contrefactuelle | 0:50 | 14:04 |
| 17 | Intercalaire · Partie 4 | 0:08 | 14:12 |
| 18 | Confronter les trois familles | 1:20 | 15:32 |
| 19 | Conclusion | 1:10 | 16:42 |
| 20 | Merci de votre attention | 0:20 | 17:02 |

**Total : 17:02**

Points de contrôle : **3:21** en quittant la problématique, **8:34** en attaquant les résultats, **14:12** en entrant dans la discussion.
...
J'ai réalisé mon alternance au sein de l'entité Ressources Humaines Groupe, dans l'équipe People AI. C'est le centre d'expertise en intelligence artificielle des ressources humaines du Groupe : des Data Scientists et des AI Business Analysts, qui travaillent avec l'AI Factory côté IT. Sa mission, c'est d'accompagner le déploiement d'une IA responsable sur les activités RH. Et les processus que nous touchons sont sensibles : recrutement, gestion des compétences, mobilité, formation. Dans une banque, la qualité des données et la traçabilité ne sont pas des options.

## 5. Du terrain au sujet de mémoire
*0:45 · sortir à 2:28*

Pendant l'alternance, j'ai travaillé sur trois sujets : un assistant génératif dédié au code, la normalisation et la classification de données textuelles, et enfin les biais dans les données. C'est ce troisième sujet qui a donné le mémoire, recentré sur les grands modèles de langage. Le raisonnement est simple : un modèle reproduit les régularités de ses données d'entraînement, et ces données ne sont pas neutres. Or ces modèles entrent déjà dans des usages RH — résumé de profil, identification de compétences, recommandation de postes. Il faut donc pouvoir vérifier, avant tout déploiement, qu'un système ne défavorise pas systématiquement une population. Je le précise tout de suite : ce mémoire n'est pas un audit de BNP Paribas, et il n'utilise aucune donnée interne.

## 6. Problématique
*0:45 · sortir à 3:13*

D'où ma question de recherche : comment détecter et quantifier, de façon scientifique et reproductible, le biais de genre d'un modèle génératif ? La difficulté tient à quatre choses. Le biais peut être cherché dans une représentation interne, dans une distribution de probabilités ou dans un texte généré, et ces trois lectures ne coïncident pas. Une métrique peut être parfaitement reproductible sans mesurer le préjudice pertinent. L'absence de différence détectable dans un benchmark ne prouve pas l'absence de risque. Et le genre n'est pas une variable binaire simple. J'ai donc borné le sujet au texte et au genre, pour traiter les méthodes sérieusement plutôt que superficiellement.
...
Cette image cadre tout le mémoire. En haut, la chaîne d'un modèle génératif. Le corpus d'abord : le web sur-représente certains locuteurs, et les filtres de qualité ajoutent leurs propres erreurs. Le préentraînement ensuite : maximiser la vraisemblance favorise ce qui est fréquent, sans aucune contrainte d'équité. L'alignement : il peut réduire les sorties stéréotypées sans effacer les associations internes — Gonen et Goldberg l'avaient déjà montré sur les embeddings. Et enfin le prompt et le décodage, qui déplacent encore le résultat. Le point important, c'est qu'un écart observé en sortie n'a jamais une cause unique : fréquence, morphologie, accord grammatical, tokenisation sont autant d'explications concurrentes qu'il faut écarter. En bas, les trois endroits où l'on peut mesurer. Les embeddings donnent les associations dans l'espace de représentation. Les probabilités comparent deux formulations contrôlées. Les générations regardent le texte réellement produit. Ces trois niveaux ne mesurent pas la même chose : c'est exactement pour cela que je les retiens tous les trois.

## 9. Le protocole en un coup d'œil
*2:00 · sortir à 6:46*

Voici le protocole en entier ; il se lit de gauche à droite. À gauche, le stimulus : une paire contrefactuelle. « Cet ingénieur analyse un dossier complexe avec rigueur », et « Cette ingénieure analyse un dossier complexe avec rigueur ». Le rôle, l'action et le contexte sont identiques ; seuls l'article et l'accord changent. Le corpus a été construit large, puis réduit avant l'exécution à un sous-ensemble fixe et vérifié par code : 120 paires probabilistes, 96 scénarios de génération, 36 contextes LPBS, 18 gabarits SEAT et quatre graines, soit 2 304 textes. Au centre, neuf modèles, trois par famille : les encodeurs mMiniLM, mE5-base et BGE-M3 ; les modèles masqués CamemBERT, mBERT et XLM-R-large ; et côté génératif Qwen 0,5 et 1,5 milliard, tous deux instruction-tuned, plus Mistral 7 milliards, un modèle de base. Le critère de sélection : des modèles reconnus dans la littérature, open source, et accessibles dans l'écosystème technique du Groupe — sans quoi le protocole ne serait pas réutilisable en interne. Viennent ensuite les métriques, regroupées par famille, sur lesquelles je reviens dans un instant. Et à droite, la lecture statistique, identique pour les trois familles : pour chaque paire je calcule un écart delta, masculin moins féminin ; l'intervalle de confiance vient de 5 000 réplications bootstrap appariées, la p-value de 10 000 permutations, et je corrige par Benjamini-Hochberg pour ne retenir un effet qu'à q inférieur à 0,05. Un choix volontaire, sur lequel je reviendrai : aucune agrégation en score unique.

## 10. Que mesure exactement chaque score ?
*1:40 · sortir à 8:26*

Un mot maintenant sur ce que mesurent ces scores, parce que les acronymes se ressemblent beaucoup alors que les questions posées au modèle sont différentes. WEAT compare des similarités cosinus entre vecteurs : les mots masculins sont-ils, en moyenne, plus proches de « carrière » que les mots féminins ? SEAT fait exactement le même calcul, mais le mot est d'abord inséré dans une phrase, et c'est la phrase qui est encodée. Viennent ensuite les trois scores probabilistes, et c'est là que la distinction compte. Le LPBS porte sur un seul mot : une phrase à trou, et on compare la probabilité de « il » et celle de « elle », chacune divisée par sa probabilité de base — sinon on prendrait pour un biais le simple fait que « il » est plus fréquent. Il répond à : quel genre le modèle attend-il ? La PLL, elle, porte sur la phrase entière : on masque chaque mot à tour de rôle et on somme les log-probabilités, pour comparer les deux formulations complètes. Elle répond à : laquelle des deux phrases est la plus vraisemblable ? AUL et AULA posent la même question que la PLL, mais sans masquer : une seule passe sur la phrase complète, et AULA pondère en plus chaque mot par l'attention qu'il reçoit. Elles servent de contrôle : si les trois convergent, le résultat ne vient pas de la façon dont on masque. Enfin, côté générations, on laisse le modèle écrire, puis on compte.
