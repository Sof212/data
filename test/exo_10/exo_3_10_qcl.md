...
# Calcul de sin(pi/5)
cos_pi_5 = (1 + sqrt(5)) / 4
sin_sq_pi_5 = 1 - cos_pi_5**2
sin_pi_5 = sqrt(sin_sq_pi_5)
bonne_valeur = sin_pi_5
...
{
Utilisez la relation fondamentale de la trigonométrie : $\sin^2(\theta) + \cos^2(\theta) = 1$.
}
{
La valeur exacte de $\sin \left(\frac{\pi}{5}\right)$ est $\py{bonne_valeur_latex}$.
}
{
...
\begin{python}
from sympy import *
# Calcul de sin(pi/5) (réutilisé du bloc précédent)
cos_pi_5 = (1 + sqrt(5)) / 4
sin_sq_pi_5 = 1 - cos_pi_5**2
sin_pi_5 = sqrt(sin_sq_pi_5)
...
{
Utilisez la relation $\sin(\pi - x) = \sin(x)$.
}
{
La valeur exacte de $\sin \left(\frac{4 \pi}{5}\right)$ est $\py{bonne_valeur_latex}$.
}
{
...
\begin{python}
from sympy import *
# Calcul de cos(pi/5) (donné)
cos_pi_5 = (1 + sqrt(5)) / 4

# Calcul de cos(4pi/5)
cos_4pi_5 = -cos_pi_5
bonne_valeur = cos_4pi_5
bonne_valeur_latex = latex(bonne_valeur)
\end{python}
...
{
Utilisez la relation $\cos(\pi - x) = -\cos(x)$.
}
{
La valeur exacte de $\cos \left(\frac{4 \pi}{5}\right)$ est $\py{bonne_valeur_latex}$.
}
{
...
{
Utilisez la relation $\sin(2\pi - x) = -\sin(x)$.
}
{
La valeur exacte de $\sin \left(\frac{9 \pi}{5}\right)$ est $\py{bonne_valeur_latex}$.
}
{
...
{
Utilisez la relation $\cos(2\pi - x) = \cos(x)$.
}
{
La valeur exacte de $\cos \left(\frac{9 \pi}{5}\right)$ est $\py{bonne_valeur_latex}$.
}
{
